  ...
  return (
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form
        ...
        className="flex flex-col gap-4 max-w-md w-full text-black"
      >
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-200 placeholder-gray-300"
            required
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            min={0}
            max={100}
            className="outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-200 placeholder-gray-300"
            required
          />
        </div>
        ...
        <div>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-black p-4 rounded relative w-full max-w-80">
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border border-gray-200 rounded py-1 px-2"
