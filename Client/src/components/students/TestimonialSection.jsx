// Learnova / Client / src / components / students / TestimonialSection.jsx
  ...
  return (
    <div className="pb-14 px-8 md:px-0 bg-white mt-10">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        ...
        lives. */}
        Explore real stories of achievement and progress, and how our <br />
        platform helped learners reach their goals.
      </p>
